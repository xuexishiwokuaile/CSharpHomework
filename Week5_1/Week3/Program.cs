...
namespace Week3
{
    class Program
    {
        ...
        public class OrderDetails:Order
        {
            ...
            public List<int> orderPrice = new List<int>();
        ...
        public class OrderService : OrderDetails
        {
            ...
            {
                Console.WriteLine("1.按商品名称查询\t2.按订单号查询\t3.查询商品金额\n");
                ...
                switch(type)
                {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        var m = from n in orderPrice where n > 10000 orderby n descending select n;
                        foreach (var n in m)
                            Console.WriteLine(n);
                        break;
                }
